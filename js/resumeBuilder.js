...
bio.display = function() {
    ...
    for (var skillsCount = 0; skillsCount < bio.skills.length; ++
        skillsCount) {
...
education.display = function() {
    for (var schoolsCount = 0; schoolsCount < education.schools.length; ++
        schoolsCount) {
        ...
        var formattedSchoolMajor = HTMLschoolMajor.replace(
            "%data%",
            education.schools[schoolsCount].majors);
    ...
    for (var onlineCount = 0; onlineCount < education.onLineCourses
        .length; ++
        onlineCount) {
        $("#education").append(HTMLschoolStart);
...
var work = {
    "jobs": [{
        ...
        },
        {
            ...
            "location": "Spanish Fork, UT",
            "dates": "1994-present",
            "description": "Perform engineering design, computer modeling, and testing of " +
...
work.display = function() {
    for (var jobCount = 0; jobCount < work.jobs.length; ++
        jobCount) {
...
//are zero images zero images otherwise causes error.
var projects = {
    "projects": [{
            "title": "Certification testing",
            "dates": "2007-2016",
            "description": "Performed tests and submitted tests for certification.  " +
                           "Tests were in accorande with IEC standards and included " +
                           "Power Performance, Acoustic, and Loads.",
        ...
        },
        {
            ...
            "dates": "2012-2015",
            "description": "Designed, built and tested components in accelerated fatige " +
                           "tests to evaluate fatigue life.",
            "images": [
                "images/CFT_4660Overspeed-360_small.jpg",
...
projects.display = function() {
    for (var i = 0; i < projects.projects.length; ++i) {
        ...
        if (projects.projects[i].images.length > 0) {
            for (var j = 0; j < projects.projects[i].images.length; ++
                j) {
